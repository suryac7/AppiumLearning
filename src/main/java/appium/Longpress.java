...
public class Longpress {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		//Scroll into webview then click that element
		AppiumBy Scroll = (AppiumBy) AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Expandable Lists\"));");
		driver.findElement(Scroll).click();
		
		//Click Custom adpator
		WebElement adaptor = driver.findElement(By.xpath("//android.widget.TextView[@resource-id=\"android:id/text1\" and @text=\"1. Custom Adapter\"]"));
		adaptor.click();
		
		//LongPress
	    WebElement names = driver.findElement(By.xpath("//*[@text='People Names']"));
	    ((JavascriptExecutor) driver).executeScript("mobile: longClickGesture", ImmutableMap.of(
	            "elementId", ((RemoteWebElement) names).getId(),"duration",2000));
