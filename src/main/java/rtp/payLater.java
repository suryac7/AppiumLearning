...
public class payLater {
	...
	public static void rtp() throws InterruptedException {
		...
		//PayLater
		WebElement payLater = driver.findElement(By.xpath("//android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[4]"));
		payLater.click();
		WebElement date = driver.findElement(By.xpath("//android.widget.EditText[@resource-id=\"text-input-outlined\"]"));
		date.click();
		WebElement date1 = driver.findElement(By.xpath("//*[@text='28']"));
		date1.click();
		WebElement schedulePayment = driver.findElement(By.xpath("//android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[3]"));
